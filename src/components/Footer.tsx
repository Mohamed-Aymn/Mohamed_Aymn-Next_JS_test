...
function Footer() {
    return (
        <footer className="text-[#484848] border-none outline-none w-full mx-0 px-0">
            <div className="w-full max-w-screen-xl mx-auto py-4 md:py-8 border-none px-0">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 gap-8">
                        {routes.map((route) => (
                            <li key={route.name}>
                                <a
                                    href={route.href}
                                    className="py-2 px-3 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 flex gap-[0.1em]"
                                >
